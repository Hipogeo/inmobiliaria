    ...
    >
      ...
      <header className="fixed top-0 z-50 w-full border-b border-white/10 bg-black/70 backdrop-blur-md">
        <div className="mx-auto flex max-w-[1400px] items-center justify-between px-8 py-4 text-white">
          ...
          <nav className="hidden md:flex gap-8 text-[11px] uppercase tracking-widest opacity-80">
            <a href="/" className="hover:opacity-100 transition">Inicio</a>
            <a href="/propiedades" className="hover:opacity-100 transition">Propiedades</a>
            <a href="/nosotros" className="hover:opacity-100 transition">Nosotros</a>
      ...
      <section
        ...
        className="h-screen flex items-center px-8 relative"
      >
        <div className="mx-auto max-w-[1400px] w-full transform scale-[0.85]">
          <h2 className="text-5xl font-bold mb-12 tracking-tight">Propiedades seleccionadas</h2>
          ...
          >
            {properties.map((p) => (
              <a
                ...
                className="min-w-[320px] bg-white shadow-2xl rounded-[32px] overflow-hidden flex-shrink-0 hover:translate-y-[-10px] transition-transform duration-500"
              >
                <img src={p.images?.[0]} className="h-[220px] w-full object-cover" />
                <div className="p-8">
      ...
      >
        ...
        <div className="relative z-20 text-center max-w-3xl px-6 transform scale-[0.85]">
          <h2 className="text-6xl font-bold mb-8">Nosotros</h2>
      ...
      <section
        ...
        className="h-screen flex items-center justify-center text-white relative px-8"
      >
        <img
        ...
        <div className="relative text-center max-w-3xl transform scale-[0.85]">
          <p className="mb-6 text-xs uppercase tracking-[0.4em] text-gray-400">Contacto</p>
          <h2 className="text-7xl font-bold mb-8 leading-tight">Hablemos de tu próxima propiedad</h2>
          <a
            href="/contacto"
            className="inline-block bg-white text-black px-12 py-5 rounded-full text-xs font-bold uppercase tracking-widest hover:bg-gray-200 transition shadow-xl"
          >
            Contactar ahora
          </a>
        </div>
      ...
      <a
        ...
        target="_blank"
        className="fixed bottom-10 right-10 z-50 bg-[#25D366] w-14 h-14 rounded-full flex items-center justify-center shadow-2xl hover:scale-110 transition-all"
      >
        <svg viewBox="0 0 32 32" fill="white" className="w-7 h-7"><path d="M19.11 17.53c-.28-.14-1.64-.81-1.9-.9-.26-.1-.45-.14-.64.14-.19.28-.73.9-.9 1.09-.17.19-.33.21-.61.07-.28-.14-1.17-.43-2.23-1.37-.83-.74-1.39-1.66-1.56-1.94-.17-.28-.02-.43.13-.57.13-.13.28-.33.42-.5.14-.17.19-.28.28-.47.09-.19.05-.35-.02-.5-.07-.14-.64-1.55-.88-2.12-.23-.56-.47-.49-.64-.5h-.54c-.19 0-.5.07-.76.35-.26.28-1 1-1 2.43s1.03 2.82 1.17 3.01c.14.19 2.02 3.08 4.89 4.32.68.29 1.21.46 1.63.59.69.22 1.32.19 1.82.12.56-.08 1.64-.67 1.87-1.32.23-.65.23-1.21.16-1.32-.07-.11-.25-.17-.53-.31z" /><path d="M16 3C9.37 3 4 8.37 4 15c0 2.64.86 5.08 2.3 7.07L4 29l7.16-2.23C13.1 27.58 14.52 28 16 28c6.63 0 12-5.37 12-12S22.63 3 16 3zm0 22c-1.36 0-2.68-.34-3.85-.98l-.27-.15-4.25 1.33 1.39-4.14-.18-.28A9.94 9.94 0 0 1 6 15c0-5.52 4.48-10 10-10s10 4.48 10 10-4.48 10-10 10z" /></svg>
      </a>
    </main>
  );
}